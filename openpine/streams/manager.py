...
class MarketDataStreamManager:
    ...
    def set_adapter(self, adapter: "LiveDataFeedAdapter | None") -> None:
        ...
        log.info(
            "market_data_stream_manager.adapter_set",
    ...
    def subscribe(
        ...
        for sub in self._subscriptions.values():
            if (
                ...
                log.debug(
                    "market_data_stream_manager.already_subscribed",
    ...
    def unsubscribe(self, subscription_id: str) -> None:
        ...
        if sub is None:
            log.warning(
                "market_data_stream_manager.unsubscribe.not_found",
        ...
        log.info(
            "market_data_stream_manager.unsubscribe", subscription_id=subscription_id
        )
    ...
    def pause(self, subscription_id: str) -> None:
        ...
        if sub is None:
            log.warning(
                "market_data_stream_manager.pause.not_found",
                subscription_id=subscription_id,
            )
            return
    ...
    def resume(self, subscription_id: str) -> None:
        ...
        if sub is None:
            log.warning(
                "market_data_stream_manager.resume.not_found",
                subscription_id=subscription_id,
            )
            return
        sub.status = SubscriptionStatus.ACTIVE
