    ...
    def __init__(
        ...
        *,
        ...
        self._bars_cache: dict[
            tuple[str, str, str, str], tuple[int, int, list[Any], list[int]]
        ] = {}
    ...
    def get_bars(
        ...
        *,
        ...
        if start_ms is None or end_ms is None:
            raise ValueError(
                "Pine runtime marketdata requests require bounded start/end"
            )
        ...
        fetched = [
            from_contract_bar(bar) for bar in self._orchestrator.load_bars(query).bars
        ]
