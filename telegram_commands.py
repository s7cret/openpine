...
TELEGRAM_COMMANDS: tuple[TelegramCommandSpec, ...] = (
    ...
    _cmd("/data_plan", "data", "Data plan", ("data", "plan"), "/data_plan [--strategy STRATEGY_ID] [--explain]", "Show data requirements."),
    ...
    _cmd("/data_ensure_active", "data", "Data ensure active", ("data", "ensure-active"), "/data_ensure_active", "Ensure active universe data.", "fixed"),
    _cmd("/data_backfill_active", "data", "Data backfill active", ("data", "backfill-active"), "/data_backfill_active", "Backfill active universe.", "fixed"),
    _cmd("/data_aggregate", "data", "Data aggregate", ("data", "aggregate"), "/data_aggregate SYMBOL --from 1m --to 5m,15m", "Aggregate timeframes."),
