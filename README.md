...
![OpenPine 4.0.2 architecture](docs/assets/openpine-architecture.png)
...
- `ast2python @ v4.0.2`
- `pinelib @ v4.0.2`
- `backtest-engine @ v4.0.2`
- `marketdata-provider @ v4.0.2`
- `optimizer @ v4.0.2`
