...
describe('TV Parity API and UI contracts', () => {
  ...
  it('keeps TV parity inputs app-controlled instead of browser-locale editable controls', () => {
    ...
    expect(enMessages.tvParity.chooseFile).toBe('Choose file')
    expect(enMessages.tvParity.noFile).toBe('No file selected')
    ...
    expect(pageSource).toContain("t('tvParity.chooseFile')")
    expect(pageSource).toContain("t('tvParity.noFile')")
