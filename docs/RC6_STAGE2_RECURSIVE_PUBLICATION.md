...
Комплект перенесён обычным fast-forward: OpenPine `5fbb5907f44aefb1f56674d2be7781d9e7cda37c`, Pine2AST `9820fe4f28d01d32d8a13f328517d9d7a5779497`, PineLib `97902943bd8f1300c3bb3e3e314465ac92fa057a`, Ast2Python `caadb136a52dcb49cea7bb838e8a0d5d2724cf30`. Remote refs повторно прочитаны перед публикацией. Финальный gate `34597926403` на двух интерпретаторах подтвердил неизменённый Stage1 агрегатор, 80 метаданных/архитектурных регрессий, постоянный lint/build и одинаковый итоговый tree. Эти 80 случаев пересекаются с исходными 20 259 и не увеличивают знаменатель. Последующий коммит меняет только документы и progress/integration receipts, не runtime/tests/CI.
