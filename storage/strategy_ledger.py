...
class StrategyLedger:
    ...
    def upsert_position(self, position: StrategyPosition) -> StrategyPosition:
        ...
        position_id = existing.position_id if existing is not None else position.position_id
        created_at = existing.created_at if existing is not None else position.created_at
