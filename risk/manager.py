...
class MaxOrdersPerMinuteRule(RiskRule):
    ...
    def __init__(self, max_orders: int = 10) -> None:
        ...
        self._order_counts: dict[str, list[int]] = defaultdict(list)  # account_id -> [timestamps]
...
class RiskManager:
    ...
    def __init__(self, global_kill_switch: bool = False) -> None:
        ...
        self._order_counts: dict[str, list[int]] = defaultdict(list)  # account_id -> [timestamps]
        self._violations: dict[str, list[str]] = defaultdict(list)  # account_id -> [error messages]
